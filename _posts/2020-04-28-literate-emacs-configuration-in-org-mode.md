---
title: "Literate Emacs Configuration in org-mode"
date: 2020-04-28
categories: [Tools]
tags: [emacs, tooling, org-mode]
---

If you use [emacs][emacs] at all, you'll
...
Enter [org-mode][orgmode]. Originally begun as an outlining
tool, `org-mode` has acquired a ton of additional functionality,
including the capability for [literate programming][literate].
...
and then [tangle][tangle] that
file to produce the code which `emacs` actually runs and documentation
(in HTML, [LaTeX][latex], or other formats).

You can see my `emacs` configuration [on github][emacsd]. My emacs
...
[emacsinst]: <https://www.gnu.org/software/emacs/manual/html_node/efaq/Installing-Emacs.html>
[emacsd]: https://github.com/tammymakesthings/emacs_d
[emacswin]: https://www.gnu.org/software/emacs/manual/html_node/efaq-w32/Location-of-init-file.html
[orgmarkup]: https://orgmode.org/guide/Markup.html

Ready? Let's go!

1. Install Emacs. Instructions for various platforms are
   [here][emacsinst]. As of 04/2020, you should install Emacs 26. A version
   of org-mode is bundled with Emacs, so no installation is needed there.
...
2. If you have an existing `.emacs.d` directory, rename it and create
   ...
   Linux and MacOS X systems). On Windows systems, consult
   [this guide][emacswin] to work out where your home directory lives.
...
4. Also inside the `.emacs.d` directory, create a new file called
   ...
   documentation as you want (following the `org-mode`
   [markup syntax][orgmarkup]. You can also put
...
- **The auto-tangling code.** This bit of [Emacs lisp][elisp]
...
preferences. The [Emacs Wiki][emacswiki] has
[links][sampleconfig] to some
good examples. You can also look at [my configuration][emacsd] for
...
[manual][orgmanual] has lots more information about how this works.

[emacs]: https://www.gnu.org/software/emacs/
[emacswiki]: https://www.emacswiki.org/
[initorg]: https://github.com/tammymakesthings/emacs_d/blob/master/init.org
[latex]: https://www.latex-project.org
[literate]: <https://https://en.wikipedia.org/wiki/Literate_programming>
[orgmanual]: <https://orgmode.org/manual/Working-with-Source-Code.html#Working-with-Source-Code>
[orgmode]: https://orgmode.org/
[sampleconfig]: https://www.emacswiki.org/emacs/ExampleConfigurations
